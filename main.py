...
def on_startup():
    ...
    with Session(engine) as session:
        ...
        # 2. FORCE RESET AND SEED (Overwrite everything)
        # We delete all existing Items and Activities to ensure exactly 37 items.
        print("FORCED RESET: Clearing and Re-seeding database...")
        ...
        for item_data in items_to_add:
            ...
            activity = Activity(
                ...
                user="System Admin",
                comment="Bulk Entry (Reset State)",
                status="Approved"
            )
